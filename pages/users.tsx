...
function Users() {
  ...
  const tailwindClasses = {
    ...
    content:
      'flex relative mx-1 mb-1 md:mx-0 md:pl-[1rem] md:mr-4 md:w-full pt-1 md:py-[1rem] flex flex-col md:flex-row gap-1 md:gap-[1rem] z-[1] md:grow-0 items-stretch h-full overflow-hidden',
