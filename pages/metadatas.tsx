...
const MetadataPage = () => {
  const tailwindClasses = {
    ...
    content:
      "flex relative mx-1 md:mx-0 md:mr-4 md:pl-[1rem] pt-1 md:py-[1rem] flex flex-col md:flex-row gap-1 md:gap-[1rem] z-[1] md:flex-grow",
    ...
    mobileTabOption: "",
    formButton:
      "m-[10px] bg-transparent hover:bg-sidebar text-sidebar font-semibold hover:text-white py-2 px-4 border border-sidebar hover:border-transparent rounded",
  };
  ...
  return (
    <>
      ...
      <div className={tailwindClasses.content}>
        <div
          className={`${tailwindClasses.box} ${
            activeMobileTab === "Skills"
              ? tailwindClasses.mobileBoxShow
              : tailwindClasses.mobileBoxHidden
          }`}
        >
          <MetadataComponent
            type="skill"
